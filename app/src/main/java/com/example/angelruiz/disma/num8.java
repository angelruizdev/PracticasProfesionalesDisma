...
public class num8 extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        new Handler().postDelayed(new Runnable() {
            @Override
            public void run() {
                mp01 = MediaPlayer.create(num8.this, R.raw.n8);
                mp01.start();
            }
        },1000);
        }
    public void OnClick(View v) {
        ...
        switch (v.getId()) {
            case R.id.bt01:
                mp01 = MediaPlayer.create(num8.this, R.raw.volv1);
                mp01.start();
                break;
            case R.id.bt02:
                mp02 = MediaPlayer.create(num8.this, R.raw.nu8);
                mp02.start();
                View view = getLayoutInflater().inflate(R.layout.alertpersoocho,null);
                ventanas.setView(view);
                ventanas.setCancelable(false);
                new Handler().postDelayed(new Runnable() {
                    @Override
                    public void run() {
                        Intent back8 = new Intent(num8.this, n1.class);
                        startActivity(back8);
                    }
                },2500);
                ...
                break;
            case R.id.bt03:
                mp03 = MediaPlayer.create(num8.this, R.raw.volv);
                mp03.start();
                break;
            case R.id.bt04:
                mp04 = MediaPlayer.create(num8.this, R.raw.n8);
                mp04.start();
                break;
        }
        }
