...
public class pn31 extends Activity implements View.OnClickListener {

    private ProgressBar pBar;
    private EditText entrada,entrada1;
    private TextView salida,salida1,salida3;
    private Button bt1,op1,op2,op3,btnSuma,btnInicio,btnSiguiente,tvResult,uno;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pn31);
...
//________________________________________________________________________________
        ...
        while(x <= 10) {
            ...
            num4 = rand.nextInt(7) + 1;
            op2 = (Button) findViewById(R.id.op2);
            num5 = rand.nextInt(7) + 1;
...
//________________________________________________________________________________
    ...
    public void calcular(View v) {
        //AlertDialog.Builder ventanas = new AlertDialog.Builder(pn31.this);
        intentos--;
        ...
        if(intentos == 0 && buenas == 7){
            AlertDialog.Builder ventanas1 = new AlertDialog.Builder(pn31.this);
            mp1.start();
            View view1 = getLayoutInflater().inflate(R.layout.alertperso5, null);
            ...
            btnSiguiente.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    Intent siguiente = new Intent(pn31.this, pn32.class);
                    startActivity(siguiente);
                }
            });
            AlertDialog alert = ventanas1.create();
            alert.show();
        }else if(intentos == 0 && buenas < 7){

            Intent datos = new Intent(this,alertperso7.class);
            Bundle hacer = new Bundle();
            hacer.putString("DATOS", String.valueOf(buenas + "\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t" + malas));
            datos.putExtras(hacer);
            startActivity(datos);
...
/*
  public EditText entrada;
    ...
    public TextView salida1;
    public Button bt1, bt2;
    public MediaPlayer mp1;
    public int intentos = 5;

    int num1, num2, ingresar;
    int tot = 0;
        ...
        if (entrada.getText().toString().equals("")) {
            ...
            if (intentos == 0 && tot == 5) {
                ...
                ventanas.setPositiveButton("---->", new DialogInterface.OnClickListener() {
                    ...
                    @Override
                    public void onClick(DialogInterface arg0, int arg1) {
                        Intent inicio = new Intent(pn31.this, pn32.class);
                ...
                ventanas.setNeutralButton("<----", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        Intent volver = new Intent(pn31.this, Menus.class);
                ...
                ventanas.setPositiveButton("Jugar de nuevo", new DialogInterface.OnClickListener() {
                    ...
                    @Override
                    public void onClick(DialogInterface arg0, int arg1) {
                        Intent inicio = new Intent(pn31.this, pn31.class);
                        startActivity(inicio);
                    }
                });
                ventanas.show();
